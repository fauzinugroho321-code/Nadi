...
export default function HRDashboard() {
  ...
  // Total kehadiran yang tercatat hari ini (untuk persentase)
  ...
  return (
    <main className="flex-1 overflow-y-auto px-5 py-4 pb-20" style={{ scrollbarWidth: "none" }}>
      <div className="flex items-center justify-between mb-4">
        ...
        {totalAttention > 0 && (
          <div className="flex items-center gap-2 px-3 py-2 rounded-xl text-[11px] font-bold text-amber-400 bg-amber-500/10 border border-amber-500/20 shadow-[0_0_20px_rgba(245,158,11,0.07)] animate-pulse">
            <AlertCircle size={12} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5 mb-3.5">
        ...
        {/* Panel 3: Payroll Draft (Statik Sementara Karena Blm Ada Table Draft Payroll) */}
        <Panel>
